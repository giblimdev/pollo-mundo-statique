/*cree polloData.ts et un composant race.tsx (utilise le Data)
la page utilisera le composant*/
...
/*cree un composant MercadoColombiano.tsx presentttion generale du marché des oauf en colombie en generale. */
